...
* Qual a probabilidade de você [acertar a sena]{.hl} em alguma das primeiras $1.000$ vezes que você jogar? $10.000$ vezes? $100.000$ vezes (o que equivale a [cerca de $`r round((1e5 / 2) / 52, 0) %>% fm(0)`$ anos, jogando $2$ vezes por semana)]{.hl}?
