...
\item
  ...
  \end{enumerate}
\item
  Se você nunca tiver estudado técnicas de contagem, ou se quiser revisar ou aprender mais, consulte o excelente livro Oliveira Morgado et al. (\protect\hyperlink{ref-oliveira-2004-analis}{2004}).
\end{itemize}
...
Oliveira Morgado, Augusto César de, João Bosco Pitombeira de Carvalho, Paulo Cezar Pinto Carvalho, e Pedro Jesus Fernandez. 2004. \emph{An{á}lise combinat{ó}ria e probabilidade}. Rio de Janeiro: Impa / Vitae.
