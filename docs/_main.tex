...
\item
  Vamos mudar isto passando um vetor de limites das classes (\emph{breaks}). Vamos acrescentar rótulos também:
...
\end{Shaded}
  ...
  \end{rmdcaution}
\item
  Os {\hl{quartis}} são os valores que estão nas posições $\frac14$, $\frac12$ e $\frac34$ da fila. São o {\hl{primeiro, segundo e terceiro quartis}}.
\item
...
\end{Shaded}
\item
  Na verdade, o algoritmo para calcular o quantil $q$ \href{https://pt.wikipedia.org/wiki/Quantil\#Quantis_de_uma_amostra}{é um pouco mais complexo}; por isso, existem diferenças entre os valores que calculamos ``à mão'', acima, e os valores retornados por \texttt{quantile}.
\item
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-44-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-55-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-57-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-58-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-59-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{_main_files/figure-latex/unnamed-chunk-65-1} \end{center}
