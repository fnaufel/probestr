...
* Para incluir o sexo, podemos [facetar]{.hl} o gráfico. Usando `facet_wrap`^[O nome da variável segundo a qual facetar deve aparecer depois de um `~`.], geramos dois subgráficos lado a lado:
